<?php return [
    ...
    'components' => [
        ...
        'single_marker_map_by_toraid' => [
            'name' => 'Map with single TORA marker',
            'description' => 'Render map with one marker on it by TORA ID',
            'marker_title' => 'Marker',
            'marker_description' => 'Marker to display on map',
            'find_by_title' => 'Find marker by',
            'find_by_description' => 'Use this parameter to find the marker',
        ...
        'marker_map_from_resulset' => [
            'name' => 'Marker map from resultset',
            'description' => 'Marker map from resultset in Session',
            'marker_title' => 'Marker',
            'marker_description' => 'Marker to display on map',
            'find_by_title' => 'Find marker by',
            'find_by_description' => 'Use this parameter to find the marker',
